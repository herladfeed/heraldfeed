    ...
    try:
        ...
        for link_tag in links:
            ...
            if href.startswith("http"):
                ...
                product_url = "https://www.motelrocks.com" + href
            ...
            if image_url.startswith("/"):
                image_url = "https://www.motelrocks.com" + image_url
    ...
    try:
        ...
        for link_tag in product_links:
            ...
            if href.startswith("http"):
                ...
                product_url = "https://www.carhartt-wip.com" + href
            ...
            if image_url.startswith("/"):
                image_url = "https://www.carhartt-wip.com" + image_url
...
if len(new_blocks) > 0:
    subprocess.run(["git", "add", "."], cwd="C:\\Website")
    subprocess.run(["git", "commit", "-m", "Daily product update"], cwd="C:\\Website")
    subprocess.run(["git", "push"], cwd="C:\\Website")
